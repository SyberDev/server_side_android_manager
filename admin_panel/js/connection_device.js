...
var device_connection = {
    controller_url: 'controller/controller_device.php'
    , debug_mode: false
...
device_connection.get_grid_call_back = function (data) {
    ...
    grid_device.cols = [
        {name: 'id', hidden: true, type: 'text'}, {name: 'name', hidden: false, type: 'text'}, {
            ...
            hidden: false,
            type: 'text'
        }, {name: 'createdby', hidden: true, type: 'text'}, {name: 'creationdate', hidden: true, type: 'text'}];

    grid_device.actions= [{name:'select' , ClassName: 'glyphicon glyphicon-ok', attribute:[{name : 'onclick' , value:'selectDevice(this)'}] }]
