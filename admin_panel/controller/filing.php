...
class filing
{
    ...
    public static function create_file_in_dir()
    {
    ...
    public static function move_dir()
    {

    }

    public static function remove_dir()
    {

    }

    public static function rename_dir()
    {
