...
//            }
            ...
            $result = access_contact::get_contact_by_deviceid($device_id);
            controller_main_function::send_result($result);
            break;
        ...
        case 'contact_set':
            ...
            $valid_data = controller_main_function::check_validation(array("name", "contactid",  "createdby"));
            if (!isset($valid_data['is_valid']) || $valid_data['is_valid'] == false) {
                controller_main_function::send_msg(lang::$invalid_data, lang::$error);
            }
            $device_id = $_SESSION["device"]["id"];
            $result = access_contact::set_contact($_REQUEST["name"], $_REQUEST["contactid"], $device_id, $_REQUEST["createdby"]);
            //controller_main_function::send_result($result);
            //$result = array('data'=> true);
            //controller_main_function::send_result($result);
            controller_main_function::send_msg(lang::$success, lang::$message, "success");
