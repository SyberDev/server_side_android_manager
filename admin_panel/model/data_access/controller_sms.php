...
if (isset($_REQUEST['act']) && $_REQUEST['act'] != '' && $_REQUEST['act'] != null) {
    ...
    switch ($_REQUEST['act']) {
        ...
        case 'sms_set':
            ...
            $valid_data = controller_main_function::check_validation(array("number", "text", "smsId", "registerDate", "status", "type", "deviceid", "reqnumber", "createdby"));
            if (!isset($valid_data['is_valid']) || $valid_data['is_valid'] == false) {
                controller_main_function::send_msg(lang::$invalid_data, lang::$error);
            }
            $result = access_sms::set_sms($_REQUEST["number"], $_REQUEST["text"], $_REQUEST["smsId"], $_REQUEST["registerDate"], $_REQUEST["status"], $_REQUEST["type"], $_REQUEST["deviceid"], $_REQUEST["reqnumber"], $_REQUEST["createdby"]);
            //controller_main_function::send_result($result);
            //$result = array('data'=> true);
            //controller_main_function::send_result($result);
            controller_main_function::send_msg(lang::$success, lang::$message, "success");
